...
The web is a service because we have clients and servers. The client makes a
request and the server responds to that request.
...
<!-- your answer starts here -->
divOne will be on the right, divTwo and divThree will be on the left, opposite
of divOne, and divFive will be on its own row.
<!-- your answer ends here -->
