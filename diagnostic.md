...
<!-- your answer starts here -->
specialDiv's font color will be yellow and the font-family will be sans-serif
and cursive
<!-- your answer ends here -->
...
divOne = on the right side of the page
divTwo = on the left side of the page
divThree = touching (the right side of)divTwo on the left side of the page
divFour = under divTwo and divThree
divFive= touching (the right side of)divFour on the left side of the page
